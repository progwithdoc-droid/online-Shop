...
export default function VendorComplaints() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'IN_REVIEW': return 'bg-amber-50 text-amber-700 border-amber-250';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              {complaints.map((comp) => (
                ...
                >
                  ...
                  <p className="text-xs text-slate-650 dark:text-slate-350 line-clamp-2 mt-2">
                    {comp.body}
                  </p>
        ...
        <div>
          {selectedComplaint ? (
            <div className="p-6 bg-white dark:bg-dark-900 border border-slate-205 dark:border-slate-850 rounded-2xl space-y-6 shadow-sm sticky top-24">
              <div>
              ...
              <div className="space-y-3 text-xs">
                ...
                {selectedComplaint.resolution && (
                  <div>
                    ...
                    <p className="text-slate-750 dark:text-slate-300 p-3 bg-green-50/20 border border-green-200 rounded-lg leading-relaxed mt-1">{selectedComplaint.resolution}</p>
                  </div>
                )}
              </div>
